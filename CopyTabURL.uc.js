...
(function () {
  ...
  const $parentItem = document.createElement("menu");
  ...
  const $menupopup = document.createElement("menupopup"); // メニューポップアップ要素が必要 https://developer.mozilla.org/ja/docs/Mozilla/Tech/XUL/menupopup
